...
export function SideNav() {
  ...
  return (
    <div
      className="flex flex-col items-center border-r py-2"
      style={{ width: 48, background: "var(--tv-bg)", borderColor: "var(--tv-border)" }}
    >
      {/* Logo */}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive ? "bg-[#2962ff] text-white" : ""
              )}
              style={isActive ? {} : { color: "var(--tv-muted)" }}
